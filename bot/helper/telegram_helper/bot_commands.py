...
class BotCommands:
    ...
    ShopCommand = f"shop{i}"
    BuyCommand = f"buy{i}"
    DuckRaceCommand = [f"duavit{i}", f"duckrace{i}"]
    WerewolfCommand = [f"masoi{i}", f"werewolf{i}"]
    ...
    AttackBossCommand = [f"danhboss{i}", f"attack{i}", f"autoboss{i}"]
