...
- `bot/modules/atri_memory.py`: recent chat persistence and retention.
- `bot/modules/atri_long_memory.py`: durable memory extraction, retrieval, dedupe and cleanup.
